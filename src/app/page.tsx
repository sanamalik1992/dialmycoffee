    ...
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          <div className="group p-6 rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 hover:border-amber-500/50 transition-all">
      ...
      <div className="space-y-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link
            ...
            className="group p-6 rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10 transition-all"
          >
